  ...
  render() {
    return (
      <div className="catch-of-the-day">
        ...
        <Inventory storeId={this.props.params.storeId} removeFish={this.removeFish} addFish={this.addFish} updateFish={this.updateFish} loadFish={this.loadFish} fishes={this.state.fishes} />
      </div>
    )
  }
}
